...
class SubscriptionController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/subscription::subscription.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/subscription::subscription.create'));
    ...
    public function edit(int $id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/subscription::subscription.edit') . ' "' . $Subscription->name . '"');
